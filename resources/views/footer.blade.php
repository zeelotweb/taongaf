        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex gap-6">
                    ...
                    <a href="{{ route('community') }}" class="text-sm text-zinc-400 hover:text-zinc-600">Community</a>
                    <a href="{{ route('about') }}" class="text-sm text-zinc-400 hover:text-zinc-600">About</a>
                </div>
